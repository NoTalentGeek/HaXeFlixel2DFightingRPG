...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "HaXeFlixel2DFightingRPG", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "HaXeFlixel2DFightingRPG";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HaXeFlixel2DFightingRPG", null, { width: 1024, height: 576 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "88",
			company: "HaxeFlixel",
			file: "HaXeFlixel2DFightingRPG",
			fps: 60,
			name: "HaXeFlixel2DFightingRPG",
