...
class HXCPP_CLASS_ATTRIBUTES  TiledTileSet_obj : public hx::Object{
	...
	public:
		...
		virtual ::flixel::addons::editors::tiled::TiledImageTile getImageSourceByGid( int Gid);
		Dynamic getImageSourceByGid_dyn();

		virtual ::flixel::addons::editors::tiled::TiledImageTile getImageSource( int ID);
