...
Void TiledTile_obj::resolveFlipAndRotation( ){
{
		...
		HX_STACK_LINE(51)
		bool flipHorizontal = tmp2;		HX_STACK_VAR(flipHorizontal,"flipHorizontal");
		HX_STACK_LINE(52)
		...
		HX_STACK_LINE(52)
		bool flipVertical = tmp5;		HX_STACK_VAR(flipVertical,"flipVertical");
		HX_STACK_LINE(54)
...
int TiledTile_obj::resolveTilesetID( ){
	HX_STACK_FRAME("flixel.addons.editors.tiled.TiledTile","resolveTilesetID",0x0ea8a396,"flixel.addons.editors.tiled.TiledTile.resolveTilesetID","flixel/addons/editors/tiled/TiledTile.hx",84,0x237a79c5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(85)
	int tmp = this->tileID;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(85)
