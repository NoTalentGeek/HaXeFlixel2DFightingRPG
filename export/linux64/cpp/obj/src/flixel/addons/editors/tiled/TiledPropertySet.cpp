...
{
HX_STACK_FRAME("flixel.addons.editors.tiled.TiledPropertySet","new",0x0ee1ea52,"flixel.addons.editors.tiled.TiledPropertySet.new","flixel/addons/editors/tiled/TiledPropertySet.hx",15,0x279539bc)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(16)
...
::String TiledPropertySet_obj::get( ::String Key){
	HX_STACK_FRAME("flixel.addons.editors.tiled.TiledPropertySet","get",0x0edc9a88,"flixel.addons.editors.tiled.TiledPropertySet.get","flixel/addons/editors/tiled/TiledPropertySet.hx",20,0x279539bc)
	HX_STACK_THIS(this)
...
bool TiledPropertySet_obj::contains( ::String Key){
	HX_STACK_FRAME("flixel.addons.editors.tiled.TiledPropertySet","contains",0x498ff2ed,"flixel.addons.editors.tiled.TiledPropertySet.contains","flixel/addons/editors/tiled/TiledPropertySet.hx",25,0x279539bc)
	HX_STACK_THIS(this)
	HX_STACK_ARG(Key,"Key")
	HX_STACK_LINE(26)
	::haxe::ds::StringMap tmp = this->keys;		HX_STACK_VAR(tmp,"tmp");
...
::String TiledPropertySet_obj::resolve( ::String Name){
	HX_STACK_FRAME("flixel.addons.editors.tiled.TiledPropertySet","resolve",0x30670dde,"flixel.addons.editors.tiled.TiledPropertySet.resolve","flixel/addons/editors/tiled/TiledPropertySet.hx",30,0x279539bc)
	HX_STACK_THIS(this)
...
Dynamic TiledPropertySet_obj::keysIterator( ){
	HX_STACK_FRAME("flixel.addons.editors.tiled.TiledPropertySet","keysIterator",0x218013d0,"flixel.addons.editors.tiled.TiledPropertySet.keysIterator","flixel/addons/editors/tiled/TiledPropertySet.hx",35,0x279539bc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(36)
	::haxe::ds::StringMap tmp = this->keys;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(36)
...
{
		HX_STACK_FRAME("flixel.addons.editors.tiled.TiledPropertySet","extend",0xeb97fb28,"flixel.addons.editors.tiled.TiledPropertySet.extend","flixel/addons/editors/tiled/TiledPropertySet.hx",40,0x279539bc)
		HX_STACK_THIS(this)
