...
::AgnosticCharacter AgnosticCharacter_obj::MovementObjectCharacter( ){
	HX_STACK_FRAME("AgnosticCharacter","MovementObjectCharacter",0x5f14f134,"AgnosticCharacter.MovementObjectCharacter","AgnosticCharacter.hx",34,0x761bded7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(37)
...
::AgnosticCharacter AgnosticCharacter_obj::PreventMovementContradictionObjectCharacter( ){
	HX_STACK_FRAME("AgnosticCharacter","PreventMovementContradictionObjectCharacter",0x4274bdd9,"AgnosticCharacter.PreventMovementContradictionObjectCharacter","AgnosticCharacter.hx",83,0x761bded7)
	HX_STACK_THIS(this)
	HX_STACK_LINE(85)
	bool tmp = this->downButtonPressedBool;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(85)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(AgnosticCharacter_obj,downButtonPressedBool),HX_HCSTRING("downButtonPressedBool","\x58","\x2c","\x8a","\xb1")},
	...
	{hx::fsBool,(int)offsetof(AgnosticCharacter_obj,upButtonPressedBool),HX_HCSTRING("upButtonPressedBool","\x3f","\x76","\xa0","\xff")},
	...
	{hx::fsFloat,(int)offsetof(AgnosticCharacter_obj,speedFloat),HX_HCSTRING("speedFloat","\x95","\xf4","\x64","\x35")},
	{ hx::fsUnknown, 0, null()}
};
